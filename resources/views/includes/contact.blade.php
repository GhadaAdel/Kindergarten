                    ...
                    <div class="row g-0">
                        <div class="col-lg-6 wow fadeIn" data-wow-delay="0.1s">
                            <div class="h-100 d-flex flex-column justify-content-center p-5">
                                <p class="mb-4"> {{ __('messages.contactForm')}}<a href="https://htmlcodex.com/contact-form">Download Now</a>.</p>
                                ...
                                <form action="{{route('contact.send')}}" method="post" enctype="multipart/form-data">
                                    ...
                                    <div class="row g-3">
                                        ...
                                        <div class="col-12">
                                            <div class="form-floating">
                                                <textarea class="form-control border-0" placeholder="Leave a message here" name="msg" id="message" style="height: 100px"></textarea>
